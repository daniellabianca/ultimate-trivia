    ...
    function makeTrivia() {
        ...
        easy.forEach((currentQuestion, questionNumber) => {
          ...
          `<label for="radio1" label class="radio btn active d-block">
              <input type="button" id="radio1" class="btn btn-outline-info btn-sm btn-group-toggle" data-toggle="radio" autocomplete="off" active><span> ${currentQuestion.answers[letter]} </span> </label>` 
                );
            }
